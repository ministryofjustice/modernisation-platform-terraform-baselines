module "securityhub-alarms-test" {
  ...
  disable_alarm_actions_events_alarm_name                    = var.disable_alarm_actions_events_alarm_name
  disable_alarm_actions_events_metric_filter_name            = var.disable_alarm_actions_events_metric_filter_name
  disable_alarm_actions_events_metric_name                   = var.disable_alarm_actions_events_metric_name
  ...
  vpn_changes_alarm_name                                     = var.vpn_changes_alarm_name
  vpn_changes_metric_filter_name                             = var.vpn_changes_metric_filter_name
  ...
  critical_role_trust_relationship_changes_alarm_name        = var.critical_role_trust_relationship_changes_alarm_name
  critical_role_trust_relationship_changes_metric_filter_name = var.critical_role_trust_relationship_changes_metric_filter_name
  ...
  iam_user_deletion_by_untrusted_role_alarm_name             = var.iam_user_deletion_by_untrusted_role_alarm_name
  iam_user_deletion_not_by_automation_metric_filter_name     = var.iam_user_deletion_not_by_automation_metric_filter_name
