...
func TestTerraformSecurityHubAlarms(t *testing.T) {
	...
	assert.Regexp(t, regexp.MustCompile(`^iam_policy_changes_createpolicy_filter$`), IamPolicyChangesMetricFilterIds["CreatePolicy"])
	...
	assert.Regexp(t, regexp.MustCompile(`^cloudtrail_configuration_changes_createtrail_filter$`), CloudtrailConfigurationChangesMetricFilterIds["CreateTrail"])
	assert.Regexp(t, regexp.MustCompile(`^cloudtrail_configuration_changes_deletetrail_filter$`), CloudtrailConfigurationChangesMetricFilterIds["DeleteTrail"])
	...
	assert.Regexp(t, regexp.MustCompile(`^s3_bucket_policy_changes_putbucketpolicy_filter$`), S3BucketPolicyChangesMetricFilterIds["PutBucketPolicy"])
	assert.Regexp(t, regexp.MustCompile(`^s3_bucket_policy_changes_deletebucketpolicy_filter$`), S3BucketPolicyChangesMetricFilterIds["DeleteBucketPolicy"])
	...
	assert.Regexp(t, regexp.MustCompile(`^config_configuration_changes_stopconfigurationrecorder_filter$`), ConfigConfigurationChangesMetricFilterIds["StopConfigurationRecorder"])
	assert.Regexp(t, regexp.MustCompile(`^config_configuration_changes_putconfigurationrecorder_filter$`), ConfigConfigurationChangesMetricFilterIds["PutConfigurationRecorder"])
	...
	assert.Regexp(t, regexp.MustCompile(`^security_group_changes_createsecuritygroup_filter$`), SecurityGroupChangesMetricFilterIds["CreateSecurityGroup"])
	assert.Regexp(t, regexp.MustCompile(`^security_group_changes_deletesecuritygroup_filter$`), SecurityGroupChangesMetricFilterIds["DeleteSecurityGroup"])
