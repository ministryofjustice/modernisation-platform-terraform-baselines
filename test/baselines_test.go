...
func TestTerraformSecurityHubAlarms(t *testing.T) {
	...
	IamPolicyChangesMetricFilterIds := terraform.OutputMap(t, terraformOptions, "iam_policy_changes_metric_filter_ids")
	IamPolicyChangesAlarmArn := terraform.Output(t, terraformOptions, "iam_policy_changes_alarm_arn")
	CloudtrailConfigurationChangesMetricFilterIds := terraform.OutputMap(t, terraformOptions, "cloudtrail_configuration_changes_metric_filter_ids")
	...
	NaclChangesMetricFilterIds := terraform.OutputMap(t, terraformOptions, "nacl_changes_metric_filter_ids")
	...
	assert.NotEmpty(t, IamPolicyChangesMetricFilterIds)
	assert.Contains(t, IamPolicyChangesMetricFilterIds, "CreatePolicy")
	assert.Contains(t, IamPolicyChangesMetricFilterIds, "DeletePolicy")
	assert.Regexp(t, regexp.MustCompile(`^`+regexp.QuoteMeta(IamPolicyChangesMetricFilterName)+`-CreatePolicy$`), IamPolicyChangesMetricFilterIds["CreatePolicy"])
	assert.Regexp(t, regexp.MustCompile(`^`+regexp.QuoteMeta(IamPolicyChangesMetricFilterName)+`-DeletePolicy$`), IamPolicyChangesMetricFilterIds["DeletePolicy"])
	...
	assert.NotEmpty(t, CloudtrailConfigurationChangesMetricFilterIds)
	assert.Contains(t, CloudtrailConfigurationChangesMetricFilterIds, "CreateTrail")
	assert.Contains(t, CloudtrailConfigurationChangesMetricFilterIds, "DeleteTrail")
	assert.Regexp(t, regexp.MustCompile(`^`+regexp.QuoteMeta(CloudtrailConfigurationChangesMetricFilterName)+`-CreateTrail$`), CloudtrailConfigurationChangesMetricFilterIds["CreateTrail"])
	assert.Regexp(t, regexp.MustCompile(`^`+regexp.QuoteMeta(CloudtrailConfigurationChangesMetricFilterName)+`-DeleteTrail$`), CloudtrailConfigurationChangesMetricFilterIds["DeleteTrail"])
	...
	assert.NotEmpty(t, S3BucketPolicyChangesMetricFilterIds)
	assert.Contains(t, S3BucketPolicyChangesMetricFilterIds, "PutBucketPolicy")
	assert.Contains(t, S3BucketPolicyChangesMetricFilterIds, "DeleteBucketPolicy")
	...
	assert.Regexp(t, regexp.MustCompile(`^`+regexp.QuoteMeta(ConfigConfigurationChangesMetricFilterName)+`-StopConfigurationRecorder$`), ConfigConfigurationChangesMetricFilterIds["StopConfigurationRecorder"])
	assert.Regexp(t, regexp.MustCompile(`^`+regexp.QuoteMeta(ConfigConfigurationChangesMetricFilterName)+`-PutConfigurationRecorder$`), ConfigConfigurationChangesMetricFilterIds["PutConfigurationRecorder"])
	...
	assert.NotEmpty(t, SecurityGroupChangesMetricFilterIds)
	assert.Contains(t, SecurityGroupChangesMetricFilterIds, "CreateSecurityGroup")
	assert.Contains(t, SecurityGroupChangesMetricFilterIds, "DeleteSecurityGroup")
	assert.Regexp(t, regexp.MustCompile(`^`+regexp.QuoteMeta(SecurityGroupChangesFilterName)+`-CreateSecurityGroup$`), SecurityGroupChangesMetricFilterIds["CreateSecurityGroup"])
	assert.Regexp(t, regexp.MustCompile(`^`+regexp.QuoteMeta(SecurityGroupChangesFilterName)+`-DeleteSecurityGroup$`), SecurityGroupChangesMetricFilterIds["DeleteSecurityGroup"])
	...
	assert.NotEmpty(t, NaclChangesMetricFilterIds)
	assert.Contains(t, NaclChangesMetricFilterIds, "CreateNetworkAcl")
	assert.Contains(t, NaclChangesMetricFilterIds, "DeleteNetworkAcl")
	assert.Regexp(t, regexp.MustCompile(`^`+regexp.QuoteMeta(NaclChangesMetricFilterName)+`-CreateNetworkAcl$`), NaclChangesMetricFilterIds["CreateNetworkAcl"])
	assert.Regexp(t, regexp.MustCompile(`^`+regexp.QuoteMeta(NaclChangesMetricFilterName)+`-DeleteNetworkAcl$`), NaclChangesMetricFilterIds["DeleteNetworkAcl"])
	assert.Regexp(t, regexp.MustCompile(`^arn:aws:cloudwatch:eu-west-2:[0-9]{12}:alarm:`+NaclChangesAlarmName), NaclChangesAlarmArn)
	assert.NotEmpty(t, NetworkGatewayChangesMetricFilterIds)
	assert.Contains(t, NetworkGatewayChangesMetricFilterIds, "CreateInternetGateway")
	assert.Contains(t, NetworkGatewayChangesMetricFilterIds, "DeleteInternetGateway")
	...
	assert.Regexp(t, regexp.MustCompile(`^`+regexp.QuoteMeta(RouteTableChangesMetricFilterName)+`-CreateRoute$`), RouteTableChangesMetricFilterIds["CreateRoute"])
	assert.Regexp(t, regexp.MustCompile(`^`+regexp.QuoteMeta(RouteTableChangesMetricFilterName)+`-DeleteRoute$`), RouteTableChangesMetricFilterIds["DeleteRoute"])
	...
	assert.NotEmpty(t, VpcChangesMetricFilterIds)
	assert.Contains(t, VpcChangesMetricFilterIds, "CreateVpc")
	assert.Contains(t, VpcChangesMetricFilterIds, "DeleteVpc")
	assert.Regexp(t, regexp.MustCompile(`^`+regexp.QuoteMeta(VpcChangesMetricFilterName)+`-CreateVpc$`), VpcChangesMetricFilterIds["CreateVpc"])
	assert.Regexp(t, regexp.MustCompile(`^`+regexp.QuoteMeta(VpcChangesMetricFilterName)+`-DeleteVpc$`), VpcChangesMetricFilterIds["DeleteVpc"])
	...
	assert.Equal(t, "securityhub-events-alerting", SecurityhubEventsMetricFilterIds["securityhub_events"])
	assert.Regexp(t, regexp.MustCompile(`^arn:aws:cloudwatch:eu-west-2:[0-9]{12}:alarm:securityhub-events-alerting$`), SecurityhubEventsAlarmArn)
	...
	assert.Equal(t, "critical-role-trust-relationship-changes", CriticalRoleTrustRelationshipChangesMetricFilterIds["critical_role_trust_relationship_changes"])
	assert.Regexp(t, regexp.MustCompile(`^arn:aws:cloudwatch:eu-west-2:[0-9]{12}:alarm:critical-role-trust-relationship-changes$`), CriticalRoleTrustRelationshipChangesAlarmArn)
	...
	assert.Equal(t, "iam-user-deletion-not-by-automation", IamUserDeletionNotByAutomationMetricFilterId)
	assert.Regexp(t, regexp.MustCompile(`^arn:aws:cloudwatch:eu-west-2:[0-9]{12}:alarm:iam-user-deletion-by-untrusted-role$`), IamUserDeletionByUntrustedRoleAlarmArn)
}
