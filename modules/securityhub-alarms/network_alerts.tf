...
resource "aws_cloudwatch_log_metric_filter" "vpn-changes" {
  name           = var.vpn_changes_metric_filter_name
...
resource "aws_cloudwatch_metric_alarm" "vpn-changes" {
  ...
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = "1"
  metric_name         = var.vpn_changes_metric_filter_name
  namespace           = "LogMetrics"
  period              = "300"
  statistic           = "Sum"
  threshold           = "1"
...
resource "aws_cloudwatch_log_metric_filter" "network_firewall_changes" {
  ...
  name           = var.network_firewall_changes_metric_filter_name
...
resource "aws_cloudwatch_metric_alarm" "network_firewall_changes" {
  ...
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = "1"
  metric_name         = var.network_firewall_changes_metric_filter_name
  namespace           = "LogMetrics"
  period              = "300"
  statistic           = "Sum"
  threshold           = "1"
