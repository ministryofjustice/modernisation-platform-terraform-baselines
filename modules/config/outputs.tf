...
output "access_keys_rotated_aws_config_config_rule_arn" {
  value       = aws_config_config_rule.access-keys-rotated.arn
  ...
  value       = aws_config_config_rule.account-part-of-organizations.arn
  ...
  value       = aws_config_config_rule.cloud-trail-cloud-watch-logs-enabled.arn
  description = "The ARN of the config config rule for cloud trail cloud watch logs enabled"
}

  output "cloud-trail-encryption-enable_aws_config_config_rule_arn" {
  value       = aws_config_config_rule.cloud-trail-encryption-enable.arn
  ...
  value       = aws_config_config_rule.cloud-trail-log-file-validation-enabled.arn
  ...
  value       = aws_config_config_rule.cloudtrail-enabled.arn
  ...
  value       = aws_config_config_rule.cloudtrail-s3-dataevents-enabled.arn
  ...
  value       = aws_config_config_rule.cloudtrail-security-trail-enabled.arn
  ...
  value       = aws_config_config_rule.iam-group-has-users-check.arn
  ...
  value       = aws_config_config_rule.iam-no-inline-policy-check.arn
  ...
  value       = aws_config_config_rule.iam-password-policy.arn
  ...
  value       = aws_config_config_rule.iam-root-access-key-check.arn
  ...
  value       = aws_config_config_rule.iam-user-mfa-enabled.arn
  ...
  value       = aws_config_config_rule.iam-user-unused-credentials-check.arn
  ...
  value       = aws_config_config_rule.mfa-enabled-for-iam-console-access.arn
  ...
  value       = aws_config_config_rule.multi-region-cloudtrail-enabled.arn
  ...
  value       = aws_config_config_rule.root-account-mfa-enabled.arn
  ...
  value       = aws_config_config_rule.s3-account-level-public-access-blocks.arn
